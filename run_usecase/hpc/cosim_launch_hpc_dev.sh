...
export CO_SIM_MODULES_ROOT_PATH="${CO_SIM_ROOT_PATH}/my-forked-repos/TVB-NEST-usecase1"
export CO_SIM_USE_CASE_ROOT_PATH="${CO_SIM_ROOT_PATH}/my-forked-repos/TVB-NEST-usecase1"
